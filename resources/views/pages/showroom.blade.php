        ...
        <div class="py-16 bg-gradient-to-br from-white to-brand-cream/30 ">
            <div class="container mx-auto px-4">
                <div class="grid lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <div class="bg-white rounded-lg  p-6 mb-8">
                            ...
                            <div class="flex items-start mb-6">
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-semibold mb-2">Showroom Hours</h3>
                                    <p class="text-gray-600">
                    ...
                    <!-- What You'll See -->
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900 mb-8">What You'll See</h2>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-white rounded-lg  p-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        <h3 class="text-lg font-semibold mb-2">Fence Displays</h3>
                                        <p class="text-gray-600">Full-size fence sections showcasing vinyl, aluminum, and wood options with various heights and styles.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded-lg  p-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        <h3 class="text-lg font-semibold mb-2">Color & Material Samples</h3>
                                        <p class="text-gray-600">Touch and feel actual fence materials. See true colors and textures before making your decision.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded-lg  p-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        <h3 class="text-lg font-semibold mb-2">Gate Hardware</h3>
                                        <p class="text-gray-600">Working gate displays with hinges, latches, and automatic operators you can test yourself.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded-lg  p-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        <h3 class="text-lg font-semibold mb-2">Expert Consultation</h3>
                                        <p class="text-gray-600">Speak with our experienced team about your project requirements and get professional recommendations.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="bg-white py-16">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">Why Visit Our Showroom?</h2>
                    <p class="text-lg text-gray-600">See the quality difference that 49 years of experience makes</p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">No surprises. See exactly what you're getting before installation.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">Experience the superior quality of American-made materials.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">Our team will help you choose the perfect solution for your needs.</p>
                    </div>
                </div>
            </div>
        </div>

<x-app-layout>
    <div class="relative">
        <div class="hidden sm:block relative min-h-[500px] lg:min-h-[550px] overflow-hidden">
            ...
            <img src="{{ Vite::asset('resources/images/home_hero.webp') }}"
                 ...
                 decoding="sync"
                 loading="eager">
            <div class="relative z-10 min-h-[500px] lg:min-h-[550px]">
                    ...
                    <div class="w-1/2 flex items-center justify-center p-8 lg:p-12 2xl:p-16">
                        <div class="mx-auto max-w-2xl 2xl:max-w-3xl text-center bg-black/30 backdrop-blur-sm rounded-3xl p-8 lg:p-10 2xl:p-12" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <h1 class="mx-auto font-display text-5xl font-bold tracking-tight text-white sm:text-7xl lg:text-7xl 2xl:text-8xl hero-title-shadow" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <span class="relative whitespace-nowrap text-outdoor-gold block text-5xl sm:text-7xl lg:text-7xl 2xl:text-8xl">
                                ...
                                <div class="flex items-center justify-center gap-1 mt-2" data-aos="zoom-in" data-aos-delay="800">
                                    <i class="fas fa-star text-3xl text-outdoor-gold drop-shadow-lg"></i>
                                    <i class="fas fa-star text-3xl text-outdoor-gold drop-shadow-lg"></i>
                                    <i class="fas fa-star text-3xl text-outdoor-gold drop-shadow-lg"></i>
                                    <i class="fas fa-star text-3xl text-outdoor-gold drop-shadow-lg"></i>
                                    <i class="fas fa-star text-3xl text-outdoor-gold drop-shadow-lg"></i>
                                </div>
                                <span class="text-3xl sm:text-4xl lg:text-4xl 2xl:text-5xl mt-0">Fence Company</span>
                            </h1>

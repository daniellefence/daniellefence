                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <a href="{{ route('diy.products') }}#vinyl" class="text-[#8e2a2a] font-semibold hover:underline">
                                Learn More →
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <a href="{{ route('diy.products') }}#aluminum" class="text-[#8e2a2a] font-semibold hover:underline">
                                Learn More →
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <a href="{{ route('diy.products') }}#wood" class="text-[#8e2a2a] font-semibold hover:underline">
                                Learn More →
                            </a>
                        </div>
                    </div>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                    <div class="text-center">
                        <i class="fas fa-map-marker-alt text-[#8e2a2a] mb-2"></i>

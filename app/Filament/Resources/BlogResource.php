    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('create_with_chatgpt')
                    ...
                    ->action(function (array $data) {
                        $prompt = "Write a {$data['length']} blog post about '{$data['topic']}' in a {$data['tone']} tone for a fence company website.";
                        
                        if (!empty($data['key_points'])) {
                            $prompt .= " Make sure to include these key points: {$data['key_points']}.";
                        }
                        
                        $prompt .= " Format the response as JSON with the following structure: {\"title\": \"Blog Post Title\", \"excerpt\": \"Brief excerpt under 500 characters\", \"content\": \"Full HTML content with proper headings and paragraphs\"}. Make the content SEO-friendly and engaging for fence customers.";
                        
                        $blog = Blog::create([
                            'title' => 'AI Generated: ' . $data['topic'],
                            'slug' => \Illuminate\Support\Str::slug('ai-generated-' . $data['topic']),
                            'excerpt' => 'AI-generated blog post about ' . $data['topic'],
                            'content' => '<p>This blog post was generated using AI. Please edit the content to customize it for your needs.</p><p><strong>Topic:</strong> ' . $data['topic'] . '</p><p><strong>Tone:</strong> ' . $data['tone'] . '</p><p><strong>Length:</strong> ' . $data['length'] . '</p>' . (!empty($data['key_points']) ? '<p><strong>Key Points:</strong> ' . $data['key_points'] . '</p>' : ''),
                            'blog_category_id' => $data['blog_category_id'],
                            'author_id' => auth()->id(),
                            'published' => false,
                        ]);
                        
                        redirect()->route('filament.admin.resources.blogs.edit', $blog);
                    })
                    ->modalHeading('Generate Blog Post with AI')
                    ->modalDescription('Use AI to create a blog post draft. You can edit and customize the content after generation.')
                    ->modalWidth('lg')

...
class SeoPolicy
{
    ...
    {
        return $user->can('force_delete_seo');
    }
    ...
    {
        return $user->can('force_delete_any_seo');
    }
    ...
    {
        return $user->can('restore_any_seo');
    }

...
class KeywordPolicy
{
    ...
    {
        return $user->can('delete_any_keyword');
    }
    ...
    {
        return $user->can('force_delete_keyword');
    }
    ...
    {
        return $user->can('force_delete_any_keyword');
    }
    ...
    {
        return $user->can('restore_keyword');
    }
    ...
    {
        return $user->can('restore_any_keyword');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Keyword $keyword): bool
    {
        return $user->can('replicate_keyword');
    }
    ...
    {
        return $user->can('reorder_keyword');
    }
}
